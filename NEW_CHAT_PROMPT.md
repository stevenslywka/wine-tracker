...
- Latest production UI work: mobile Wine Detail hero/header polish with wine-name sticky header, bottle/location/drinking-window hero row, centered Drink History edit dialog, hidden redundant Bottles `+ Add` when inventory exists, Set Count zero-confirm safety, purchase-detail chevron, and collapsed-section polish.
