...
- Latest production UI work: wine-family grouping rework — size-blind `wines.family_key` (Magnum/375ml/1.5L wording ignored) and a collapsible mobile "Vintages" section on Wine Detail listing every family member with availability/incoming/drank info.
