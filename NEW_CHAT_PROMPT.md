...
- Latest production UI work: scan re-buy detection — label scans match against the cellar, Add Wine scan UIs show an "Already in your cellar" banner, and "Add another bottle" deep-links to `/wine/<id>?rebuy=1` which opens the mobile Add bottles sheet.
